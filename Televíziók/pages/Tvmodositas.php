...
if (filter_input(INPUT_POST, "Adatmodositas", FILTER_VALIDATE_BOOL, FILTER_NULL_ON_FAILURE)) {
    ...
    if ($db->setTv($tvid, $tv_neve, $ar, $marka, $kepatlo, $hz, $felbontas, $kijelzo, $megjegyzes)) {
...
*   <input type="hidden" name="tvid" value="<?php echo $adatok['tvid']; ?>">
    ...
    <a href="index.php?menu=uservasarlas&id=<?php echo $id; ?>&tvid=<?php echo $adatok['tvid']; ?>" class="btn btn-primary">Vásárlás</a>
</form>
<?php ?>